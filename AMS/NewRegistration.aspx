<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewRegistration.aspx.cs" Inherits="WebApplication1.AMS.NewRegistration" MasterPageFile="~/AMS/Site1.Master" %>
...
<%--<body>
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server">
                        ...
                        <asp:Label ID="lblOutput" runat="server" BackColor="#FFCCCC" BorderColor="White" BorderStyle="Dashed" BorderWidth="2px" Width="250px"></asp:Label>
        &nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label2" runat="server" BackColor="#FFCCCC" BorderColor="White" BorderStyle="Dashed" BorderWidth="2px" Width="250px" CssClass="auto-style4"></asp:Label>

        <center class="auto-style5">
            <strong style="margin: 50px; font-weight: bold; color: #003300; background-color: #33CCFF; border-color: #000000; border-style: dashed; font-size: xx-large;">Registration Form</strong><br />
        </center>
        <%--<div>
            <select id="Select1">
 ...
 --%>            </div>
            ...
            <div class="form-group">
                  <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Insert" CssClass="btn" /> &nbsp&nbsp
...
<br />
                ...
                <asp:GridView ID="GridView1"  Visible="false" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="UserID" DataSourceID="SqlDataSource10" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="3px">
                    <Columns>
