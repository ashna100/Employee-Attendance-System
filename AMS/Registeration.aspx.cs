...
namespace WebApplication1
{
    public partial class validations : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //lbl1.Text = "Hello &nbsp" + Session["Name"].ToString() + "!!";
            //lbl4.Text = "Hey your sur name is &nbsp" + Session["LastNamee"].ToString();
            //lbl2.Text = "Your Email ID is &nbsp" + Session["Email"].ToString();
            //lbl3.Text = "Your hidden password is &nbsp" + Session["Password"].ToString();
            ////if (!IsPostBack)
            //{
            ...
            //        TextBox1.Text = da.Rows[0][1].ToString();
            //        TextBox2.Text = da.Rows[0][2].ToString();
            //        txtDob.Items.FindByValue(da.Rows[0][3].ToString()).Selected = true;
            //        DropDownList1.Items.FindByValue(da.Rows[0][4].ToString()).Selected = true;
            //        DropDownList2.Items.FindByValue(da.Rows[0][5].ToString()).Selected = true;
            //        DropDownList3.Items.FindByValue(da.Rows[0][6].ToString()).Selected = true;
            //        DropDownList4.Items.FindByValue(da.Rows[0][7].ToString()).Selected = true;
            //        DropDownList5.Items.FindByValue(da.Rows[0][8].ToString()).Selected = true;
            //        TextBox9.Text = da.Rows[0][9].ToString();
            //        TextBox8.Text = da.Rows[0][10].ToString();
            //        TextBox7.Text = da.Rows[0][11].ToString();
            //        TextBox5.Text = da.Rows[0][12].ToString();
            //        TextBox6.Text = da.Rows[0][13].ToString();
            //        TextBox3.Text = da.Rows[0][14].ToString();
            //        txtDoj.Items.FindByValue(da.Rows[0][15].ToString()).Selected = true;
            //        TextBox10.Text = da.Rows[0][16].ToString();
            //        TextBox11.Text = da.Rows[0][17].ToString();
            //        DropDownList9.Items.FindByValue(da.Rows[0][18].ToString).Selected = true;
            //        DropDownList6.Items.FindByValue(da.Rows[0][19].ToString).Selected = true;
            //        DropDownList7.Items.FindByValue(da.Rows[0][20].ToString).Selected = true;
            //        DropDownList8.Items.FindByValue(da.Rows[0][21].ToString).Selected = true;
            //        TextBox4.Text = da.Rows[0][22].ToString();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e) //select
        {
            ...
            //txtPassword.Text = da.Cells[26].Text;
